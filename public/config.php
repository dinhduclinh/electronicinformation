...
$config['licenseName'] = 'hungtien.kimson.ninhbinh.gov.vn';
$config['licenseKey']  = 'XE3E89NBAGUGWBT75TWSEHJFJB3QL';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'http://localhost/ProjectOJT/public/uploads/',
    'root'         => '/path/to/your//public/uploads', // Đường dẫn tuyệt đối đến thư mục uploads
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
...
$config['resourceTypes'][] = array(
    'name'              => 'Quản lý File', // Single quotes not allowed.
    'directory'         => 'userfiles',
    'maxSize'           => 0,
    'allowedExtensions' => 'bmp,doc,docx,gif,gz,gzip,jpeg,jpg,mp3,pdf,png,xls,xlsx,zip,rar',
    'deniedExtensions'  => '7z,aiff,asf,avi,csv,fla,flv,gz,mid,mov,mpc,mpeg,mpg,ods,odt,ppt,pptx,pxd,qt,ram,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,vsd,wav,wma,wmv',
    'backend'           => 'default'
);
...
$config['roleSessionVar'] = $_SESSION['hungtien_akey'];
